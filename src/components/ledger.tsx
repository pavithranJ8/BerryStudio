...
const ledger = () => {
  ...
  return (
    <div className="flex h-screen bg-[#FFFFFF]">
      {/* Sidebar */}
      <div className="w-64 h-screen shadow-md flex flex-col">
      ...
      <div className="flex-1 flex flex-col bg-gradient-to-b from-[#E0F1E1] via-[#FAFDFA] to-[#FAFAFB]">
        {/* Header */}
        <div className="h-14 shadow-sm px-4 flex items-center justify-between">
        ...
        <Box className="min-h-screen p-4">
         <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="flex items-center mb-4">
            <Avatar className="text-[32px]" sx={{ width: 64, height: 64, color: '#FFFFFF',
                    backgroundColor: '#FF6F61' }}>CG</Avatar>
            <div className="ml-4">
          ...
          {/* Tabs */}
            ...
            <button
            key={tab}
            className={`px-4 py-2 text-sm font-medium h-[36px] ${
              tab != 'Related Parties'
              ? 'ml-4'
              : ''
              } ${
          ...
          {/* <Tabs 
            ...
            variant="scrollable"
            scrollButtons="auto"
            className="mb-4 bg-white rounded-t-lg"
          >
            <Tab label="Related Parties" value="related" />
            <Tab label="Insurance" value="insurance" />
            <Tab label="Tasks" value="tasks" />
            <Tab label="Tx Plan" value="txplan" />
            <Tab label="Forms" value="forms" />
            <Tab label="Ledger" value="ledger" className="bg-gray-900 text-white" />
